...
var defaultGetSize = function defaultGetSize(domElement) {
  return { width: domElement.clientWidth, height: domElement.clientHeight };
};
var defaultWidthProp = 'containerWidth';
var defaultHeightProp = 'containerHeight';
var defaultGetDisplayName = function defaultGetDisplayName(name) {
  return 'Sizer(' + name + ')';
};
    ...
    var Sizer = function (_Component2) {
      ...
      _createClass(Sizer, [{
        ...
        value: function setWrappedInstance(ref) {
          ...
          if (ref) {
            this.parentDOMNode = (0, _reactDom.findDOMNode)(ref).parentNode;
          } else {
